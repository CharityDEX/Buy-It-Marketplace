import 'package:eatit/chat_screen.dart';
...
class OrderCard extends StatefulWidget {
  final snap;
  const OrderCard({super.key, required this.snap});
      ...
      builder: (context, constraints) {
        ...
        return Card(
          margin: EdgeInsets.symmetric(
            horizontal: isNarrowScreen ? 20 : 60,
          ),
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: const TextStyle(fontSize: 12, color: Color(0xff1E3010), fontWeight: FontWeight.w500),
                ),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 16).copyWith(right: 0),
                child: Text(
                  "ID: ${widget.snap['oid']}",
                  style: const TextStyle(fontSize: 12, color: Color(0xFF82A182), fontWeight: FontWeight.w500),
                ),
              ),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 4, horizontal: 16).copyWith(right: 0),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(fontSize: 16, color: Color(0xff123113), fontWeight: FontWeight.w500),
                        ),
                      ],
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            if (widget.snap['isUserCompleted'] == false && widget.snap['isSellerCompleted'] == true) {
                              showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    ...
                                    content: const Text("Are you sure this order is received?"),
                                    actions: [
                                      IconButton(
                                        onPressed: () {
                                      ...
                                      IconButton(
                                        onPressed: () async {
                                          await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
                                              .userOrderCompleted(widget.snap['oid']);
                                          await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
                          ...
                          child: Text(
                            widget.snap['isUserCompleted'] == false
                                ? "✔️✔️ Mark as received"
                                : "✔️✔️ Marked as received",
                            style: TextStyle(
                              color: widget.snap['isUserCompleted'] == false ? Colors.black : Color(0xffA2CAA2),
                              fontWeight: FontWeight.w500,
                              fontSize: 14,
                            ),
                          ),
