...
import 'package:eatit/pages/seller/payout_page.dart';
                                  ...
                                  Row(
                                    children: [
                                      ElevatedButton(
                                        ...
                                        child: const Text('Get more badges on ethy', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xff123113)),),
                                      ),
                                      ...
                                      ElevatedButton(
                                        ...
                                        child: const Text('Upload badge', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xff123113)),),
                                      ),
                                    ],
                                  )
                                ],
