...
class CircularSliderAppearance {
  ...
  Color? get _customDotBorderColor => customColors?.dotBorderColor;
  ...
  Color get dotBorderColor => _customDotBorderColor ?? _defaultDotColor;
