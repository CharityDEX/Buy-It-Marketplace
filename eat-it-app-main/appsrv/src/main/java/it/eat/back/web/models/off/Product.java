...
//
//    @JsonAnySetter
//    void setDetail(final String key, final Object value) {
//        other.put(key, value);
//    }

    /**
     * get categories from OFF response
     * @return first element from categories
     */
    ...
    public String getCategories() {
        ...
        return categoriesList.get(0).substring(categories.indexOf(":"));
