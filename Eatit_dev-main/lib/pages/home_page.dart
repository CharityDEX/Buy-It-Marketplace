...
class _HomePageState extends State<HomePage> {
  ...
  final List<Map<String, String>> _productTypes = [
    {'name': 'Fashion', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Accessories', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Beauty', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Home', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Crafts', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Lifestyle', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Wellness', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Gifts', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Physical Goods', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Local services', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Ticketed Events', 'icon': 'assets/product_type_icon.png'},
    {'name': 'Other', 'icon': 'assets/product_type_icon.png'},
  ];
