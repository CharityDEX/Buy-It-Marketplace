...
import 'package:eatit_dev/chat_card.dart';
  ...
  Future<void> _sendMessage() async {
    if (_chatController.text.isEmpty) {
      ...
      await DatabaseService(uid: FirebaseAuth.instance.currentUser!.uid)
          .postChat(widget.snap['oid'], _chatController.text,
              FirebaseAuth.instance.currentUser!.uid, userName, userPicURL);
      setState(() {
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            child: CircleAvatar(
                              backgroundImage:
                                  NetworkImage(widget.sellerPicURL),
                              radius: 24,
                            ),
                            onTap: () {
                              nextScreen(
                                  context, SellerInfoPage(sid: widget.sid));
                            },
                          ),
                          ...
                          const SizedBox(
                            ...
                            child: VerticalDivider(
                                color: Color(0xff6A7769), thickness: 1),
                          ),
                          Column(
                            children: [
                              Image.network(widget.productUrl,
